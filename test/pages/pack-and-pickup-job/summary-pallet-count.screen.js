...
class PalletCountScreen {
    ...
    get PalletsImage() {return $('//android.widget.TextView[@text="Total Pallets"]/../preceding-sibling::android.view.ViewGroup/android.widget.ImageView');}
    get TotalPalletsText() {return $('//android.widget.TextView[@text="Total Pallets:"]');}
    get TotalPalletsNumber() {return $('//android.widget.TextView[@text="Total Pallets:"]/../following-sibling::android.view.ViewGroup/android.widget.TextView');}
