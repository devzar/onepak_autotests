...
class NumberOfPalletsScreen {
    get TopBackButton() {return $('//android.widget.TextView[@text="Number of Pallets"]/preceding-sibling::android.view.ViewGroup/android.view.ViewGroup[1]/android.widget.ImageView');}
    get HamburgerMenuButton() {return $('//android.widget.TextView[@text="Number of Pallets"]/preceding-sibling::android.view.ViewGroup/android.view.ViewGroup[2]/android.widget.ImageView');}
    
    get NumberOfPalletsText() {return $('//android.widget.TextView[@text="Number of Pallets"]');} 
    get MorePalletsThanAssetsText() {return $('//android.widget.TextView[@text="You cannot have more pallets than assets."]');} 
    get NumberOfPalletsInput() {return $('//android.widget.TextView[@text="Number of Pallets"]/following-sibling::android.widget.TextView');}
    ...
    //MorePalletsThanAssetsText
    async MorePalletsThanAssetsText_IsPresent() {
        await GeneralFunctions.ElementIsPresentOnTheScreen(this.MorePalletsThanAssetsText)
    }
    async MorePalletsThanAssetsText_IsNotPresent() {
        await GeneralFunctions.ElementIsNotPresentOnTheScreen(this.MorePalletsThanAssetsText)
    }
