...
class TakeArrivalPhotoScreen {
    get TopBackButton() {return $('//android.widget.TextView[@text="Take Photo"]/parent::android.view.ViewGroup/parent::android.view.ViewGroup/android.view.ViewGroup[1]/android.view.ViewGroup[1]');}
