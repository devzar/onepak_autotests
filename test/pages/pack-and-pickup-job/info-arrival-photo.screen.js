...
class InfoArrivalPhotoScreen {
    get TopBackButton() {return $('//android.widget.TextView[@text="Please take photos of equipment upon arrival"]/preceding-sibling::android.view.ViewGroup/android.view.ViewGroup[1]');}
    get HamburgerMenuButton() {return $('//android.widget.TextView[@text="Please take photos of equipment upon arrival"]/preceding-sibling::android.view.ViewGroup/android.view.ViewGroup[2]');}

    get IllustrationImage() {return $('//android.widget.TextView[@text="Please take photos of equipment upon arrival"]/preceding-sibling::android.widget.ImageView');}
