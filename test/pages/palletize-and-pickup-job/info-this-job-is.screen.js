...
class ThisJobIsScreen {
    ...
    get PalletizeAndPickupText() {return $('//android.widget.TextView[@text="PALLETIZE & PICKUP"]');}
    ...
    //PalletizeAndPickupText
    async PalletizeAndPickupText_IsPresent() {
        await GeneralFunctions.ElementIsPresentOnTheScreen(this.PalletizeAndPickupText)
    }
    //PackPalletsText
